...
const policy: ProjectPolicy = {
  ...
  fields: {
    priority: { projectField: "Priority", required: true, type: "string", derived: false, values: { P0: "P0" }, ownership: "core" },
    estimate: { projectField: "Estimate", required: false, type: "number", derived: false, values: {}, ownership: "core" },
    iteration: { projectField: "Iteration", required: false, type: "string", derived: true, values: {}, ownership: "derived" },
    status: { projectField: "Status", required: false, type: "string", derived: true, values: {}, ownership: "core" },
  },
  bootstrap: { coreEnabled: false, extensionFields: {} },
  milestones: {},
